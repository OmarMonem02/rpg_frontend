...
export default function MaintenancePartCategoriesPage() {
  ...
  const [editingCategory, setEditingCategory] = useState<MaintenancePartCategoryRecord | null>(null);
  ...
  const loadCategories = async () => {
    try {
      ...
      const result = await listMaintenancePartCategories(token, page);
  ...
  const handleOpenModal = (category?: MaintenancePartCategoryRecord) => {
