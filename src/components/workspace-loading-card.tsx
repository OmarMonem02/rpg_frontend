  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="glass ghost-border w-full max-w-lg rounded-[2rem] border p-8 text-center shadow-ambient">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-[1.5rem] border border-primary/15 bg-primary-container text-sm font-bold uppercase tracking-[0.24em] text-on-primary-container">
          RPG
        </div>
        <div
        ...
        />
        <div className="mt-6">
          <p className="font-display text-2xl font-semibold text-on-surface">Preparing your workshop console</p>
