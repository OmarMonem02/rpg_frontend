  ...
  const renderSectionCard = (
    ...
    return (
      <section
        ...
        className={`form-section-card scroll-mt-24 shadow-sm ${
          isStackedLayout ? `h-full ${getStackedSectionSpanClassName(section)}` : ""
        ...
        <div className="form-section-header mb-6">
          <div className="flex items-start justify-between gap-3">
            ...
            {isStackedLayout && stackedStatus !== "neutral" ? (
              <span
                className={`form-chip shrink-0 ${
                  stackedStatus === "complete"
      ...
      {contentSections.map((section, index) => {
        ...
        return (
          <button
            ...
            className={`group flex items-center gap-2 rounded-xl border border-outline-variant/10 bg-surface-container-lowest/50 text-left transition-all hover:border-outline-variant/30 hover:bg-surface-container-lowest ${
              orientation === "horizontal"
                ? "shrink-0 px-3 py-2"
                : "w-full px-3 py-2.5"
            }`}
          >
            ...
            <span
              className={`font-bold text-on-surface-variant group-hover:text-on-surface ${
                orientation === "horizontal"
  ...
  return (
    <form onSubmit={handleSubmit} className={shellClassName}>
      ...
      <div className={contentClassName}>
        ...
        {isStackedLayout ? (
          <div
            className={`pb-6 pt-4 ${pagePaddingX} ${
              contentSections.length > 1
          ...
          >
            ...
            <div
              className={`grid min-w-0 gap-6 grid-cols-1 ${
                contentSections.length > 1 ? "xl:grid-cols-2" : ""
              }`}
            >
              {contentSections.map((section, index) =>
