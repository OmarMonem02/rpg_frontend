...
export function FilterBar({ children, className = "" }: { children: ReactNode; className?: string }) {
  return <div className={`sticky top-0 z-10 grid gap-3 rounded-[1.25rem] border border-outline-variant/12 bg-surface/95 p-3 backdrop-blur-sm transition-shadow duration-200 focus-within:shadow-ambient md:grid-cols-12 ${className}`.trim()}>{children}</div>;
}
